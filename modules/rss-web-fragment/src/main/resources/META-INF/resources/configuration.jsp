	...
	<liferay-frontend:edit-form-body>
		...
		<liferay-frontend:fieldset-group>
			...
			>
				...
				<aui:input label="show-full-content" name="preferences--showEntryDescription--" type="toggle-switch" value="<%= showEntryDescription %>" helpMessage="show-entry-description-description"/>
