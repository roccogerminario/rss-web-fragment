		...
		>
			...
			for (int i = 0; i < rssFeeds.size(); i++) {
				...
				if (showEntryDescription) {
					syndFeed = (SyndFeed) syndFeed.clone();

					Field syndFeedField = RSSFeed.class.getDeclaredField("_syndFeed");
					syndFeedField.setAccessible(true);
					syndFeedField.set(rssFeed, syndFeed);

					for (RSSFeedEntry rssFeedEntry: rssFeed.getRSSFeedEntries(themeDisplay)) {

						SyndEntry syndEntry = (SyndEntry) rssFeedEntry.getSyndEntry();
